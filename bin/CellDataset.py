...
class CellData(Dataset):
 ...
 #       self.masks = glob.glob(datapath + "/realmask/*")
        self.masks = list(Path(datapath + "/training_data").glob("**/*_mask.png"))
    ...
    def __getitem__(self, idx):
        ...
        #cell_file  = mask_file.split('/')[-1]
        cell_path = str(mask_file.resolve()).strip("_mask.png") + ".png"
        #cell_path = self.datapath + "/realoriginals/" + cell_file
